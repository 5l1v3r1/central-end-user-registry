...
APP_NAME=${APP_NAME:=central-end-user-registry}
...
HOSTNAME=http://central-end-user-registry-1833170602.us-west-2.elb.amazonaws.com
POSTGRES_USER=${DEV_POSTGRES_USER}
POSTGRES_PASSWORD=${DEV_POSTGRES_PASSWORD}
POSTGRES_HOST=${DEV_POSTGRES_HOST:=ec2-35-164-236-164.us-west-2.compute.amazonaws.com}
TASK_FAMILY=central-end-user-registry
...
make_task_def() {
  DATABASE_URI=postgres://$POSTGRES_USER:$POSTGRES_PASSWORD@$POSTGRES_HOST:5432/central_end_user_registry
  task_def=$(sed \
